...
///////////////////////////////////////////////////////////////////
// Painting operations
void fipWinImage::drawEx(HDC hDC, RECT& rcDest, RECT& rcSrc, BOOL useFileBkg, RGBQUAD *appBkColor, FIBITMAP *bg) const {
    ...
    BITMAPINFOHEADER* bmHeader = FreeImage_GetInfoHeader(_display_dib);
    if (bmHeader)
    {
        ...
        {
            int height = FreeImage_GetHeight(_display_dib);
            rcSrc.top = height - rcSrc.bottom;
        }
    }

    BITMAPINFO* pBitmaHeader = (BITMAPINFO*)FreeImage_GetInfoHeader(_display_dib);
    ...
    StretchDIBits(hDC,
        ...
        srcWidth, srcHeight,
        FreeImage_GetBits(_display_dib), pBitmaHeader, DIB_RGB_COLORS, SRCCOPY);
}
