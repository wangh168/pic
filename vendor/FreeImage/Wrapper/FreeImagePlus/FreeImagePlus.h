...
public:
	...
	*/
    void draw(HDC hDC, RECT& rcDest, RECT& rcSrc) const {
        drawEx(hDC, rcDest, rcSrc, FALSE, NULL, NULL);
    }
	...
	*/
    void drawEx(HDC hDC, RECT& rcDest, RECT& rcSrc, BOOL useFileBkg = FALSE, RGBQUAD *appBkColor = NULL, FIBITMAP *bg = NULL) const;
